...
import net.steamcrafted.lineartimepicker.res.dialog_date;
import net.steamcrafted.lineartimepicker.res.dialog_time;
import net.steamcrafted.lineartimepicker.res.dialog_toolbar;
...
*/
        ...
        dialog_toolbar dToolbar = new dialog_toolbar(themedContext);

        contentView = (FrameLayout) getLayoutInflater().inflate(getLayoutResourceId(), null);

        final LinearPickerView v = (LinearPickerView) contentView.findViewWithTag("ltp");

        toolbar = (FrameLayout) dToolbar.findViewWithTag("toolbarContainer");
        btnCancel = (ImageView) dToolbar.findViewWithTag("btn_cancel");
        btnApply = (ImageView) dToolbar.findViewWithTag("btn_apply");
