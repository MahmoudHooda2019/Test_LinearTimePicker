...
public class LinearDatePickerDialog extends BaseLinearPickerDialog {
    ...
    protected int getLayoutResourceId() {
        dialog_date v = new dialog_date(getContext());
        return v.getSourceLayoutResId();
    ...
    private void init() {
        ...
        final LinearDatePickerView v = (LinearDatePickerView) contentView.findViewWithTag("ltp");
